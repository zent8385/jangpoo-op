...
class SpdController():
  ...
  def update(self, v_ego_kph, CS, sm, actuators ):
    ...
    str3 = 'curvature={:3.0f} dest={:3.0f}/{:3.0f}:{:.0f} heart={:.0f} d:{:.1f} v:{:.1f}'.format( model_speed,  target_set_speed, self.long_dst_speed,  self.long_wait_timer, self.heart_time_cnt, dRel, vRel )
    trace1.printf2(  str3 )
    #SC.add( str3 )
