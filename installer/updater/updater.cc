...
extern const uint8_t bin_opensans_regular[] asm("_binary_NotoSansKR_Regular_otf_start");
extern const uint8_t bin_opensans_regular_end[] asm("_binary_NotoSansKR_Regular_otf_end");
extern const uint8_t bin_opensans_semibold[] asm("_binary_NotoSansKR_Medium_otf_start");
extern const uint8_t bin_opensans_semibold_end[] asm("_binary_NotoSansKR_Medium_otf_end");
extern const uint8_t bin_opensans_bold[] asm("_binary_NotoSansKR_Bold_otf_start");
extern const uint8_t bin_opensans_bold_end[] asm("_binary_NotoSansKR_Bold_otf_end");
